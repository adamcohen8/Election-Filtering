...
- Applied nine previously missing Florida records after verifying complete candidate-choice crosstabs for Republican, Democratic, and Independent/NPA voters: five `fl_gov` records and four `fl_sen` records. The already-ingested UNF July governor record was retained without duplication.
- `unf_fl_gov_2025-10-15_2025-10-25_crosstab`: UNF PORL, Donalds 44.8 / Jolly 33.9, n=728 likely midterm voters. The official workbook prints Party ID subgroup Ns and candidate shares: Republican Donalds 75.6 / Jolly 5.7, n=331; Democratic Donalds 3.5 / Jolly 78.2, n=262; NPA/Other Donalds 40.4 / Jolly 28.9, n=135. NPA/Other is normalized as independent.
- `unf_fl_gov_2026-02-21_2026-03-02_crosstab` and `unf_fl_sen_2026-02-21_2026-03-02_crosstab`: UNF PORL likely-midterm-voter matchups from the official accessible workbook. The race-specific tables print complete Dem, Rep, and NPA/Other candidate shares and unweighted subgroup Ns. NPA/Other is normalized as independent.
- `emerson_fl_gov_2026-03-29_2026-03-31_crosstab` and `emerson_fl_sen_2026-03-29_2026-03-31_crosstab`: Emerson College Polling, n=1,125 likely voters. Candidate shares by party registration were calculated directly from the linked full-results workbook's weighted candidate counts and weighted party totals. The workbook prints party-registration frequencies of Democratic n=362, Republican n=465, and Independent/Other n=298.
- `stetson_fl_gov_2026-03-25_2026-04-13_assumed_n` and `stetson_fl_sen_2026-03-25_2026-04-13_assumed_n`: Stetson University CPOR, n=848. The public report prints all six Democratic, Independent, and Republican candidate shares for both matchups but does not print party-ID subgroup Ns. Per the scrub rule, every subgroup uses total N / 4 = 212.
- `unf_fl_sen_2026-07-08_2026-07-17_crosstab`: UNF PORL, Moody 50.0 / Nixon 41.6, n=848 likely midterm voters. The official workbook prints complete candidate shares and explicit subgroup Ns: Republican Moody 86.9 / Nixon 5.9, n=425; Democratic Moody 4.6 / Nixon 90.4, n=250; NPA/Other Moody 40.1 / Nixon 43.4, n=173.
- `st-pete-polls_fl_gov_2026-09-15_2026-09-17_assumed_n`: St. Pete Polls for Florida Politics, n=913 likely voters. The public release reports Donalds 43.5 / Jolly 43.4 and complete candidate shares for Republicans, Democrats, and voters outside the two major parties. The release does not print subgroup Ns, so every subgroup uses rounded total N / 4 = 228.

### Florida Polls Reviewed But Not Applied

- St. Pete Polls September 15-17 Florida Senate: the public article reports the topline and several party-registration figures, but not both Moody and Nixon shares in every Republican, Democratic, and outside-the-major-parties group. It remains excluded rather than filling missing cells by inference.
- Hart Research August 10-13 Florida governor: the public summary reports the topline, both independent shares, Jolly's Republican crossover, and Donalds' Democratic crossover, but does not expose Donalds' Republican share and Jolly's Democratic share. It remains excluded.
- Change Research September 7-9 Florida governor and Senate and Quantus Insights September 8-10 Florida Senate: aggregate toplines were public, but complete R/D/I candidate-choice crosstabs were not located. They remain excluded.
- UnidosUS May Florida governor and Senate crosstabs are complete but cover Hispanic voters rather than a statewide likely-voter electorate, so they remain excluded from the statewide models.

### Florida Polls Applied With Assumed Subgroup Ns

- Stetson University CPOR governor and Senate, March 25-April 13: each R/D/I subgroup n=212 from total N / 4.
- St. Pete Polls governor, September 15-17: each R/D/I subgroup n=228 from rounded total N / 4.

### Candidate Completion And Poll Source Follow-Up

- Filled the four previously missing nominee records after reviewing primary results: `fl_sen` Ashley Moody / Angie Nixon and `fl_gov` Byron Donalds / David Jolly from the Florida Department of State (`https://floridaelectionwatch.gov/TrackCounty/GIL` and `https://floridaelectionwatch.gov/StateOffices/Governor`); `nh_sen` John E. Sununu / Chris Pappas from New Hampshire Public Radio (`https://www.nhpr.org/politics/2026-09-08/pappas-sununu-win-senate-primaries-nh-newhampshire-elections-2026`); `nh_gov` Kelly Ayotte / Cinde Warmington from Citizens Count (`https://www.citizenscount.org/elections/2026-nh-gubernatorial-primary`). All modeled 2026 race IDs now have both major-party candidate names in the nominee registry.
- `fl_gov`: The University of North Florida July 8-17 Donalds/Jolly survey has an accessible party-registration crosstab workbook (`https://www.unfporl.org/s/PORL-2026-Summer-Statewide-Xtabs-ADA.xlsx`) and remains normalized as `unf_fl_gov_2026-07-08_2026-07-17_crosstab`; it was not duplicated. The St. Pete Polls September 15-17 release (`https://floridapolitics.com/archives/820638-poll-byron-donalds-44-david-jolly-43-in-dead-heat-race-for-florida-governor/`) was added after its article established all six candidate-by-party-registration cells.
- `fl_sen`: The same UNF July workbook includes a Moody/Nixon ballot test alongside a Moody/Vindman test. Now that Nixon is the nominee, only the Moody/Nixon row was added. St. Pete Polls' September 15-17 Moody/Nixon release (`https://floridapolitics.com/archives/820628-sunshine-state-earthquake-st-pete-polls-shows-ashley-moody-angie-nixon-neck-and-neck-in-heated-senate-race/`) still does not expose every candidate-by-R/D/independent cell in the accessible article. Quantus Insights and Change Research September rows remain aggregate-only in the public surfaces reviewed.
- `nh_sen`: UNH's August 20-24 Pappas/Sununu release (`https://scholars.unh.edu/survey_center_polls/988/`) and the September InsiderAdvantage, co/efficient, and Rasmussen releases are relevant source leads. UNH's PDF download was blocked in the earlier scrub; the accessible later releases did not establish complete R/D/I candidate-choice crosstabs. Saint Anselm's August PDF uses a `Swing` column rather than a clear Independent party-ID bucket. Do not use the obsolete Pappas/Brown ballot test for the settled Sununu/Pappas race.
- `nh_gov`: UNH's August 20-24 Ayotte/Warmington release (`https://scholars.unh.edu/survey_center_polls/991/`) describes party-ID patterns, but its exact table was not accessible in this pass. Saint Anselm's August PDF (`https://www.anselm.edu/sites/default/files/2026-08/August%2017-18%202026%20Poll.pdf`) uses `Swing` rather than Independent, while the co/efficient September page (`https://battlegrounds.coefficient.org/nh/`) exposes aggregate results and sample composition only. No new normalized poll was added.
- UnidosUS has public R/D/independent crosstabs for Moody/Nixon and Donalds/Jolly (`https://unidosus.org/wp-content/uploads/2026/05/unidosus_florida_crosstabs_may2026.pdf`), but its Florida sample is Hispanic voters only, not a statewide likely-voter electorate; it was not entered into the statewide models.
- The follow-up Florida recovery replayed the full normalized feed, refreshed the duplicate ledger and model snapshot, and regenerated the public forecast data after the nine qualifying records were added.
