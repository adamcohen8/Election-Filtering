...
- `fl_gov`: The University of North Florida July 8-17 Donalds/Jolly survey has an accessible party-registration crosstab workbook (`https://www.unfporl.org/s/PORL-2026-Summer-Statewide-Xtabs-ADA.xlsx`) and was already normalized and ingested as `unf_fl_gov_2026-07-08_2026-07-17_crosstab`; do not add it again. St. Pete Polls' September 15-17 Florida Politics release (`https://floridapolitics.com/archives/820638-poll-byron-donalds-44-david-jolly-43-in-dead-heat-race-for-florida-governor/`) reports party-registration splits, but the original full crosstab table was not retrieved in this pass. Treat it as a source-verification follow-up, not an ingested poll.
- `fl_sen`: The same UNF July workbook includes a Moody/Nixon ballot test alongside a Moody/Vindman test. Now that Nixon is the nominee, only the Moody/Nixon row is the current-candidate matchup to consider; the July log explains why neither alternate test was applied at the time. St. Pete Polls' September 15-17 Moody/Nixon release (`https://floridapolitics.com/archives/820628-sunshine-state-earthquake-st-pete-polls-shows-ashley-moody-angie-nixon-neck-and-neck-in-heated-senate-race/`) reports some party-registration splits but did not expose every candidate-by-R/D/independent cell in the accessible article. Quantus Insights and Change Research September rows remain aggregate-only in the public surfaces reviewed. No Senate row was added.
...
- This candidate and source audit did not run ingestion, replay the election model, or refresh the public forecast JSON. The normalized feed, seen-poll ledger, model snapshot, and Pages data are unchanged.
