...
NOMINEES_2026_BY_RACE: dict[str, RaceNominees] = {
    ...
    "fl_sen": RaceNominees(
        ...
        republican=Nominee(
            ...
            party="republican",
            status="nominee",
            source_name="Florida Department of State",
            source_url="https://floridaelectionwatch.gov/TrackCounty/GIL",
        ),
        democratic=Nominee(
            name="Angie Nixon",
            party="democratic",
        ...
        notes="Florida special U.S. Senate election nominees from the August 18 primary.",
    ),
    "fl_gov": RaceNominees(
        race_id="fl_gov",
        republican=Nominee(
            ...
            status="nominee",
            source_name="Florida Department of State",
            source_url="https://floridaelectionwatch.gov/StateOffices/Governor",
        ),
        democratic=Nominee(
            name="David Jolly",
            party="democratic",
        ...
        last_verified="2026-09-18",
        notes="Florida governor nominees from the August 18 primary.",
    ),
    "nh_sen": RaceNominees(
        race_id="nh_sen",
        republican=Nominee(
            ...
            source_url="https://www.nhpr.org/politics/2026-09-08/pappas-sununu-win-senate-primaries-nh-newhampshire-elections-2026",
        ),
        democratic=Nominee(
            name="Chris Pappas",
            party="democratic",
        ...
        last_verified="2026-09-18",
        notes="New Hampshire Senate nominees from the September 8 primary.",
    ),
    "nh_gov": RaceNominees(
        race_id="nh_gov",
        republican=Nominee(
            ...
            party="republican",
            status="nominee",
            source_name="Citizens Count",
            source_url="https://www.citizenscount.org/elections/2026-nh-gubernatorial-primary",
        ),
        democratic=Nominee(
        ...
        last_verified="2026-09-18",
        notes="New Hampshire governor nominees from the September 8 primary.",
    ),
    "ak_sen": RaceNominees(
        race_id="ak_sen",
        republican=Nominee(
